...
class PlaylistTrack(UUIDModel):
    playlist = models.ForeignKey(
        Playlist,
        help_text=_("The playlist this track appears on"),
        related_name="tracks",
        on_delete=models.CASCADE,
    )
    ...
    track = models.ForeignKey(
        Track,
        help_text=_("The track in the playlist appears on"),
    ...
    def get_absolute_url(self):
        return reverse("admin:grunge_playlist_track_change", kwargs={"object_id": self.pk})
